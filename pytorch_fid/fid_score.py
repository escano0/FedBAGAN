...
"""
python -m pytorch_fid /Users/zhaoyuan/Documents/ImagePrivacy/image_datasets/ffhq0k-5k /Users/zhaoyuan/Documents/ImagePrivacy/image_datasets/blurred_images
FID:

python -m pytorch_fid /Users/zhaoyuan/Documents/ImagePrivacy/image_datasets/ffhq0k-5k /Users/zhaoyuan/Documents/ImagePrivacy/image_datasets/mosaiced_images
FID:
...
def _compute_statistics_of_path(path, model, batch_size, dims, device):
    if path.endswith('.npz'):
        ...
        print("loading images from dir: {}".format(path))
